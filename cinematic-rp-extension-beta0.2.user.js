...
(function() {
    ...
    const injectCSS = () => {
        ...
        style.textContent = `
            ...
            .knd-btn-ping { background: rgba(80, 255, 120, 0.1); border: 1px solid rgba(80, 255, 120, 0.3); color: #4ade80; cursor: pointer; border-radius: 4px; padding: 4px 8px; font-size: 10px; font-weight: bold; transition: all 0.2s; }
            .knd-btn-ping:disabled { opacity: 0.5; cursor: not-allowed; }
            .knd-btn-action { background: rgba(59, 130, 246, 0.2); border: 1px solid rgba(59, 130, 246, 0.5); color: #60a5fa; padding: 8px; border-radius: 4px; cursor: pointer; font-weight: bold; font-size: 11px; text-align: center; transition: all 0.2s; }
            .knd-btn-action:hover:not(:disabled) { background: rgba(59, 130, 246, 0.4); color: #fff; }
    ...
    const initToolsLogic = () => {
        ...
        document.getElementById('btn-ping-k').addEventListener('click', (e) => pingAPI('k', e));
        document.getElementById('btn-ping-c').addEventListener('click', (e) => pingAPI('c', e));
        document.getElementById('btn-ping-g').addEventListener('click', (e) => pingAPI('g', e));
    };
