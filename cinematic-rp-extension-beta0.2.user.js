...
(function() {
    ...
    // Performance Optimization: Cache primitive values to prevent layout thrashing
    // and redundant DOM updates during high-frequency parsing.
    let lastRenderState = { loc: null, tokens: null, stats: {} };
    ...
    const renderState = () => {
        ...
        Object.keys(gameState.stats).forEach(key => {
            ...
            // Skip redundant DOM iterations if the stat hasn't changed
