...
(function() {
    ...
    const injectCSS = () => {
        ...
        style.textContent = `
            ...
            .knd-btn-action:not(:disabled):hover, .knd-btn-ping:not(:disabled):hover { background: rgba(59, 130, 246, 0.4); color: #fff; }
            .knd-btn-action.green:not(:disabled):hover { background: rgba(80, 255, 120, 0.4); color: #fff; }
