...
(function() {
    ...
    const initToolsLogic = () => {
        ...
        // ACTION: SEND JOURNAL
        document.getElementById('knd-send-journal').addEventListener('click', async function() {
            const btn = this;
        ...
        document.getElementById('btn-ping-k').addEventListener('click', function() { pingAPI('k', this); });
        document.getElementById('btn-ping-c').addEventListener('click', function() { pingAPI('c', this); });
        document.getElementById('btn-ping-g').addEventListener('click', function() { pingAPI('g', this); });
    };
