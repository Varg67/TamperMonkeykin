                ...
                if(mutation.addedNodes.length > 0) {
                    mutation.addedNodes.forEach(node => {
                        if (node.nodeType === 1 || node.nodeType === 3) {
                            ...
                            // Optimize: Use O(N) string operations instead of greedy regex to extract JSON payload
                            // This prevents catastrophic backtracking and improves performance on long text nodes.
