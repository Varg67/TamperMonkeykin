...
## 2024-05-05 - Fix API key DOM exposure
**Vulnerability:** API keys were injected directly into input values.
**Learning:** Host page scripts can read input values from injected UI, causing security risks.
**Prevention:** Store keys in memory and populate input values with a dummy mask string instead.
