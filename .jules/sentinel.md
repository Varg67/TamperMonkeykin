...
## 2024-05-24 - [Tampermonkey DOM Secret Injection]
**Vulnerability:** API keys were being initialized directly into the `value` attribute of input elements in the DOM.
**Learning:** This exposes the secrets to any script running on the host page.
**Prevention:** Store credentials securely in memory or extension storage, use placeholder text for UI feedback (`'******** (Saved)'`), and read/clear inputs only during active user interactions.
